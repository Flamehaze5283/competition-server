...
public class TeacherAutoCode {

    //配置值
    static final String author = "zh";
    ...
    static final String subProjectDir = "/competition-teacher";
    ...
    public static void main(String[] args) {
        ...
        if (pom) {
            gc.setOutputDir(projectPath + subProjectDir + "/src/main/java");
        }
         else {
